...
import { deletOne, getOne, putOne } from "../../api/productsApi";
    ...
    <div className="border-2 border-sky-200 mt-10 m-2 p-4">
      ...
      <div className="flex justify-center">
        <div className="relative mb-4 flex w-full flex-wrap items-stretch">
          ...
          <input
            ref={uploadRef}
            className="w-4/5 p-6 rounded-r border border-solid bg-sky-200 border-neutral-300 shadow-md"
            type={"file"}
            multiple={true}
          ></input>
        </div>
